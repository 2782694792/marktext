...
格式化选项介绍：[Clang-Format Style Options — Clang 18.0.0git documentation (llvm.org)](https://clang.llvm.org/docs/ClangFormatStyleOptions.html)

中英文介绍：[clang format 官方文档自定义参数介绍（中英文） (bbsmax.com)](https://www.bbsmax.com/A/VGzlMjexJb/)
