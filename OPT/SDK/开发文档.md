...
![](../..\image cache\2022-10-13-09-57-09-image.png)

2、传感器电路图

![](../..\image cache\2022-10-13-11-01-00-image.png)

![](../..\image cache\2022-10-13-10-58-11-image.png)
...
![](../..\image cache\2022-10-13-09-59-34-image.png)

![](../..\image cache\2022-10-13-11-37-49-image.png)
...
5. 参数错误（有时错误）：
   ...
   <img src="../../image cache/2022-10-11-14-59-38-image.png" title="" alt="" data-align="center">
...
6. 不安全函数（变量）：vs2019 使用更安全的 c14/c17 标准, 认为这类函数不安全。
   ...
   ![](../..\image cache\2022-10-11-15-57-25-image.png)
...
7. 流对象、属性对象、对象列表释放:
   ...
   判断节点不应以为空进行判断，而是操作标识，为空的返回在 SDK 下没有明显的返回显示，尤其是对仅有返回 0、-1 这样的数据内容，自定义操作标识来确定更加明显。
