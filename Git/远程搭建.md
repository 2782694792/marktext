...
![](..\image cache\2022-08-23-17-09-29-image.png)
...
![](..\image cache\2022-10-24-16-42-59-image.png)
...
    通过 `git add` 实现对指定文件的跟踪，然后 `git commit` 提交，假设在目录 `..\.git` 中有文件需要跟踪（版本控制），这样即得到了一个实际维护（跟踪）着若干个文件的 Git 仓库。
...
![](..\image cache\2022-11-08-14-05-56-image.png)

## 3.4 暂存已修改文件

1. 修改一个已被跟踪的文件，打开文件 `mytext.txt`，命名为 `remind.md`并编辑其中的内容，然后运行 `git status` 命令：

![](..\image cache\2022-10-24-17-42-46-image.png)
...
![](..\image cache\2022-10-25-07-06-06-image.png)
...
![](..\image cache\2022-11-05-16-40-54-image.png)
...
![](..\image cache\2022-11-01-15-56-55-image.png)
...
![](..\image cache\2022-11-01-17-01-21-image.png)
...
![](..\image cache\2022-11-10-14-11-16-image.png)
...
![](..\image cache\2022-11-01-17-25-46-image.png)
...
![](..\image cache\2022-11-03-19-57-52-image.png)
...
![](..\image cache\2022-11-03-20-01-14-image.png)
...
![](..\image cache\2022-11-03-20-19-36-image.png)
...
![](..\image cache\2022-11-03-20-24-20-image.png)
...
![](..\image cache\2022-11-03-20-25-36-image.png)
